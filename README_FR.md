...
<p align="center">475 prompts Krea 2 Turbo, chacun avec l'image qu'il a produite. Un clic pour copier.</p>
...
Ajoutez une entrée à `prompts.json` avec votre image de sortie et ouvrez une PR. Deux règles : le prompt doit être reproductible et l'image doit être la sortie non retouchée.
