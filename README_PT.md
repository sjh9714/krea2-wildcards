...
<p align="center">475 prompts do Krea 2 Turbo, cada um com a imagem que gerou. Clique para copiar.</p>
...
Adicione uma entrada em `prompts.json` com a sua imagem de saída e abra um PR. Duas regras: o prompt tem de reproduzir e a imagem tem de ser a saída sem edição.
