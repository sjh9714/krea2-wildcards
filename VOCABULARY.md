...
62 terms. 370 of 499 prompts carry at least one of them.
...
| `50mm` | **8** in 7 categories | Roughly what the eye does. The neutral choice. |
| `long lens` | **7** in 7 categories | Flattens distance and stacks the background against the subject. |
| `85mm` | **5** in 5 categories | Compresses and separates. Portrait glass. |
...
| term | entries | what it does |
|---|---|---|
| `overhead` | **27** in 18 categories | Camera above the subject looking down, not necessarily square to it. |
| `three-quarter` | **20** in 15 categories | Turned partly away. The default product and portrait angle. |
...
| `window light` ⚠️ | **9** in 9 categories | Creates soft directional daylight and may include the window. Use broad side light when you want only the effect. |
| `side light` | **8** in 6 categories | From one side. Modelling and shadow across the form. |
...
| term | entries | what it does |
|---|---|---|
| `grain` | **23** in 15 categories | Film grain, wood grain or screenprint grain depending on the noun it sits next to. All three work. |
...
| `matte` | **12** in 7 categories | No specular highlight. |
| `worn` | **9** in 7 categories | Use damage: rubbed edges, thinned paint, softened corners. |
| `seamless` ⚠️ | **9** in 5 categories | Creates a repeat-inspired surface motif. Use a tiling post-process when you need production-ready edges. |
...
| `palette` | **17** in 10 categories | The general handle. Almost always worth naming explicitly. |
...
- **`50mm`** (8): `animal-003`, `exterior-005`, `fashion-010`, `fashion-013`, `photography-004`, `portrait-005`, `product-011`, `street-005`
- **`85mm`** (5): `fashion-014`, `landscape-003`, `photography-001`, `portrait-001`, `product-013`
...
- **`overhead`** (27): `automotive-001`, `fashion-001`, `food-002`, `food-010`, `interior-007`, `interior-009`, `isometric-3d-002`, `jewellery-004`, `mirror-007`, `packaging-003`, `photography-003`, `photography-009`, `photography-014`, `plant-007`, `portrait-009`, `product-007`, `product-010`, `product-013`, `scifi-005`, `sport-001`, `stationery-003`, `stationery-004`, `stationery-006`, `still-life-002`, `still-life-008`, `street-007`, `vehicle-009`
...
- **`three-quarter`** (20): `anatomy-006`, `architecture-001`, `architecture-003`, `automotive-001`, `brand-mark-006`, `collectible-006`, `fashion-013`, `isometric-3d-004`, `isometric-3d-008`, `landscape-008`, `miniature-003`, `packaging-003`, `portrait-007`, `poster-008`, `product-017`, `product-019`, `product-020`, `product-022`, `reference-sheet-001`, `scifi-002`
...
- **`side light`** (8): `animal-007`, `fashion-004`, `fashion-008`, `fashion-010`, `food-001`, `landscape-007`, `plant-001`, `typography-011`
...
- **`window light`** (9): `collectible-005`, `fashion-014`, `interior-003`, `packaging-001`, `photography-004`, `plant-003`, `portrait-005`, `product-002`, `tattoo-002`
...
- **`matte`** (12): `brand-mark-006`, `collectible-001`, `isometric-3d-005`, `isometric-3d-007`, `isometric-3d-009`, `mineral-008`, `packaging-003`, `product-002`, `product-011`, `product-020`, `still-life-005`, `still-life-007`
...
- **`seamless`** (9): `brand-mark-006`, `fashion-016`, `pattern-001`, `pattern-002`, `pattern-005`, `pattern-007`, `pattern-008`, `portrait-002`, `product-005`
...
- **`palette`** (17): `editing-005`, `fashion-009`, `fashion-011`, `fashion-014`, `fashion-015`, `illustration-007`, `infographic-010`, `interior-008`, `interior-013`, `photography-001`, `photography-003`, `photography-006`, `photography-013`, `portrait-007`, `seasonal-004`, `still-life-008`, `weather-003`
